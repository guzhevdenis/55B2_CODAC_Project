...
/* Generated from ../O.Common/SharedTemplate.dbd */
...
int SharedTemplate_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* SharedTemplate_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"SharedTemplate_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(SharedTemplate_registerRecordDeviceDriver(*iocshPpdbbase));
}
