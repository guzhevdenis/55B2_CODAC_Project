...
/* Generated from ../O.Common/D1-I2.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devPicmgAiStats, *pvar_dset_devAoSoft,
    *pvar_dset_devAoSoftRaw, *pvar_dset_devAoSoftCallback,
    *pvar_dset_devAoStats, *pvar_dset_asynAoInt32,
    ...
    *pvar_dset_devLsiStats, *pvar_dset_asynLsiOctetCmdResponse,
    ...
    *pvar_dset_asynSiOctetRead, *pvar_dset_devPicmgSiStats,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64", "asynAiFloat64Average", "asynAiInt64",
    "devPicmgAiStats", "devAoSoft", "devAoSoftRaw", "devAoSoftCallback",
    "devAoStats", "asynAoInt32", "asynAoFloat64", "asynAoInt64",
    ...
    "devBoDbState", "devBoSimulation", "asynBoInt32",
    "asynBoUInt32Digital", "devCalcoutSoft", "devCalcoutSoftCallback",
    "devEpidSoft", "devEpidSoftCB", "devEventSoft", "devHistogramSoft",
    ...
    "asynSiOctetRead", "devPicmgSiStats", "devSoSoft",
    ...
    "asynInt64TimeSeries", "devPicmgWaveStats"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_asynAiInt64, pvar_dset_devPicmgAiStats, pvar_dset_devAoSoft,
    pvar_dset_devAoSoftRaw, pvar_dset_devAoSoftCallback,
    pvar_dset_devAoStats, pvar_dset_asynAoInt32, pvar_dset_asynAoFloat64,
    ...
    pvar_dset_asynInt64TimeSeries, pvar_dset_devPicmgWaveStats
};
...
epicsShareExtern reg_func pvar_func_NDSRegister, pvar_func_arrInitialize,
...
int D1_I2_registerRecordDeviceDriver(DBBASE *pbase)
{
...
/* D1_I2_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"D1_I2_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(D1_I2_registerRecordDeviceDriver(*iocshPpdbbase));
}
